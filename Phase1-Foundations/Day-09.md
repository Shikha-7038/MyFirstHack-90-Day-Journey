...
He received an email that appeared to be from Google warning him about suspicious login activity. The email looked genuine, and after receiving incorrect advice, he clicked the fake login page and entered his password.
...
People naturally trust authority figures, making these emails more convincing.
...
However, the lesson emphasized that the best defense is not trying to recognize every fake email but developing consistent security habits.
...
The quiz presented realistic emails and messages that required identifying whether they were legitimate or phishing attempts.
...
After reviewing the explanation, I learned that **legitimate companies never ask users to share their verification codes through email.**

This corrected an important misconception I had.
...
- Not every unfamiliar sender domain is malicious.
- Not every familiar-looking link is safe.
...
Earlier, I believed phishing could mostly be identified by poor grammar or suspicious-looking emails.

Now I understand that modern phishing attacks can appear almost identical to legitimate emails.

The most valuable lesson for me was that cybersecurity isn't about being smart enough to recognize every attack. Instead, it is about building simple habits that continue protecting me even when I am tired, distracted, or under pressure.

Rather than relying on instinct, I now know that slowing down, verifying links, checking sender information, and using 2FA are far more effective defenses.
...
- Attackers mainly exploit **urgency, authority, and curiosity**.
- Never rely solely on appearance when evaluating emails.
- Always verify sender domains and link destinations before clicking.
- Legitimate companies **never ask for your 2FA verification code through email**.
- Not every unfamiliar sender domain is malicious, and not every familiar-looking link is trustworthy.
- Consistent security habits provide better protection than relying on instinct.
...
Although AI is making phishing attacks increasingly realistic, simple habits such as verifying links, avoiding email-based logins, enabling 2FA, and confirming requests through trusted channels provide effective protection.

This lesson helped me shift my focus from trying to identify every phishing email to developing consistent security habits that reduce risk regardless of how convincing an attack may appear.