...
Instead of thinking only about attacks and technical concepts, I learned to first ask what data is being stored, why it is valuable, and why attackers want it.
...
Whether it is ransomware, phishing, malware, or account compromise, the attacker's real objective is usually the information stored inside a system.

This helped me understand that whenever I study a new cybersecurity topic, I should think about the data it is protecting rather than only the technology itself.
...
> **Data Value = Permanence + Leverage**

I understood this with simple examples.

- A stolen credit card can usually be cancelled and replaced within a few days.
- A medical record or government ID cannot simply be replaced because the information remains the same for life.
...
- Bank
- University
- Mobile Network Provider (Vi)
- Government Services (Aadhaar & PAN)
- Hospital
...
Simply creating this list made me much more aware of my own digital footprint.
...
1. **What data does this system hold?**
...
Now, whenever I look at a website or system, I naturally start by identifying the type of information it stores before thinking about technical details.
...
Instead of exporting everything, I selected only a few important services to keep the archive manageable.
...
Some of the categories I observed included:
...
Although I knew Google collected data, I had never seen it organized so clearly in one dashboard.
...
- Valuable information generally falls into three categories:
  ...
  - Credentials
  - Proprietary Data
- The value of data depends largely on its permanence and the level of access it provides.
- My personal information is distributed across many different organizations, not just my own devices.
- Understanding where my data lives is an important part of personal security.
- The three-question framework ("What data?", "Which category?", "Who wants it?") is a simple but powerful way to analyze any system from a security perspective.
- Reviewing my own Google data made me realize how much information online services collect over time and encouraged me to review my privacy settings regularly.
...
This lesson changed that perspective.

I now understand that technology is simply the infrastructure. The real asset being protected is **data**.

The biggest mindset shift for me was learning to evaluate every system by asking:
